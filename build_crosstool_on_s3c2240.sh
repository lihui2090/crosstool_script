...
CROSSTOOL_S3C_BUILD_PATH=$CROSSTOOL_NG_PATH/build_crosstool_on_s3c
build_example(){
...
cp ./config/targethost_s3c2440_config  $CROSSTOOL_NG_PATH/crosstool-ng-$CROSSTOOL_NG_VERSION/.config
cp ./config/targethost_s3c2440_config $CROSSTOOL_S3C_BUILD_PATH/.config
